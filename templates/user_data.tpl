...
su ec2-user <<'EOF'
(crontab -l 2>/dev/null; echo "0 */2 * * *      /usr/bin/docker run --rm --env cmd=sync-local-to-s3 --env DEST_S3=s3://${s3_bucket}/${ecs_cluster_name}/ -v /ecs/jenkins-home:/opt/src/jenkins-home garland/docker-s3cmd") | crontab -
EOF
